...
function isDateDDMMYYYY( Txt ){
     var res = 1; // return 1. is DateDDMMYYYY || 0. isnt DateDDMMYYYY
     if( trim( Txt.value )!= '' ){
   	today = new Date();
   	anot  = today.getFullYear();
   	mest  = today.getMonth()+1;
   	diat  = today.getDate();	
   	val   = Txt.value;
   	...
   	fecha = diat+"-"+mest+"-"+anot;
   	if( val.length > 10 ){
   	  alert("Demasiados Caracteres, Inserte una fecha de la forma  DD-MM-YYYY");
   	  res = 0;
   	  Txt.value=fecha;
   	  Txt.focus();
   	  return res;
        ...
        obtenerNroTokens(val,'-');
       
        if(nroTokens != 3 ){
          alert("Formato Fecha No V�lido, Inserte una de la forma  DD-MM-YYYY");
   	  res = 0;
   	  Txt.value=fecha;
   	  Txt.focus();
   	  return res;
  	...
  	obtenerToken(val,'-',0);
        ...
        ano   = token;;
          ...
          alert("El D�a y Mes deben ser N�mericos,Inserte una de la forma  DD-MM-YYYY");
   	  res = 0;
   	  Txt.value=fecha;
   	  Txt.focus();
   	  return res;
   	...
   	{ 
        ...
        if( ano<1870){ 
   	   ...
   	   //Txt.value=fecha;
   	   Txt.focus();
        }else if( (dia<1 || dia>31) || (mes==2 && dia>29) || ( (mes==4||mes==6||mes==9||mes==11) && dia>30 ) ){
           alert("Dia No V�lido");
   	   res = 0;
   	   //Txt.value=fecha;
   	   Txt.focus();
        }else if( (ano % 4 == 0 && (ano % 1000 == 0 || ano % 100 != 0)) && mes==2 && dia>28 ){
           alert("Dia No V�lido el a�o "+ ano + " es Bisiesto");
   	   res = 0;
   	   //Txt.value=fecha;
   	   Txt.focus();
   	}
...
function isDateDDMMYYYYnoFocus( Txt ){
     var res = 1; // return 1. is DateDDMMYYYY || 0. isnt DateDDMMYYYY
     if( trim( Txt.value )!= '' ){
   	today = new Date();
   	anot  = today.getFullYear();
...
function isDateDDMMYYYY_setOld( Txt){
     var res = 1; // return 1. is DateDDMMYYYY || 0. isnt DateDDMMYYYY
...
function fechaHoy(dif_anyo){
		var cadfechahoy
		var fecha=new Date();
		if (dif_anyo==0)
				cadfechahoy=fecha.getDate()+"-"+(fecha.getMonth()+1)+"-"+(fecha.getFullYear()-dif_anyo);
		else
				cadfechahoy="01-01-1996"
		return cadfechahoy;
}
