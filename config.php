...
$driver = "postgres";
$db = "quipuxitred_dev_comunidad";

$usuario_bodega = "";
$contrasena_bodega = "";
$servidor_bodega = "127.0.0.1:5432";
$db_bodega = "quipuxitred_dev_combodega";
...
$path_ciudadanos = "/home/quipuxitred/documentos_quipux";
...
$amd_email = "tecnico.tic@itred.edu.ec";
// email de la cuenta de soporte
$cuenta_mail_soporte = "tecnico.tic@itred.edu.ec";
// email de la cuenta desde la que se enviarán los recordatorios a los usuarios
$cuenta_mail_envio = "tecnico.tic@itred.edu.ec";

// Configuración para la conexión con otros servidores adicionales
$nombre_servidor="https://pruebas.quipux.itred.edu.ec";
...
$servidor_firma = "http://firma.quipux.itred.edu.ec:3820/api";

$servidor_viajes = "http://nombre_servidor_viajes";

$servidor_pdf = "https://pruebas.quipux.itred.edu.ec/html_a_pdf";
...
$cuenta_mail_respaldo = "tecnico.tic@itred.edu.ec";
