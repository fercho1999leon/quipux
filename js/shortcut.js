...
function shortcuts_cuerpo() {
    ...
    shortcut.add("Alt+b", function() {
        ...
        window.top.window.leftFrame.cambioMenu(codCarpeta);
    });
   ...
   shortcut.add("Ctrl+Shift+f", function() {//dar fisico
    ...
    shortcut.add("Ctrl+Shift+u", function() {//regresar
    ...
    shortcut.add("Ctrl+Shift+n", function() {//envio manual
                changedepesel(5);
    });
    ...
    shortcut.add("Ctrl+Shift+l", function() {//reataurar archivado
                changedepesel(17);
    });
    shortcut.add("Ctrl+Shift+k", function() {//eliminar informado
                changedepesel(7);
    });
    shortcut.add("Ctrl+Shift+y", function() {//enviar de bandeja por imprimir
                changedepesel(3);
    });
    shortcut.add("Ctrl+Shift+q", function() {//devolver
                changedepesel(20);
    });
     shortcut.add("Ctrl+Shift+o", function() {//recuperar
                changedepesel(83);
    });
}
function llamarListado2(nombreCarpeta, codigoCarpeta){
    return 0;
    
    }

function shortcuts_busqueda() {
    ...
    shortcut.add("Alt+b", function() {
        nomCarpeta = "En Elaboración";
        codCarpeta = "1";
        llamarListado2(nomCarpeta, codCarpeta)
        window.top.window.leftFrame.cambioMenu(codCarpeta);
    });
    shortcut.add("Alt+r", function() {
        nomCarpeta = "Recibidos";
