...
(function($) {
	...
	_oExt.oPagination = {
		 ...
		 * Purpose:  Change the number of pages which can be seen(Cambio de numero de paginas a mostrar)
	 	 * Scope:    jQuery.fn.dataTableExt.oPagination
		 */
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "",
				"sZeroRecords": "Ningún registro de correspondencia encontrado",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text" maxlength="100" style="background-color: rgb(242, 242, 242);border-color:#132fdb" title="Puede buscar texto de cualquier columna"/>';
