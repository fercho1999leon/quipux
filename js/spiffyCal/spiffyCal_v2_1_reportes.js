...
// GLOBAL variables
if (typeof(ruta_raiz) != 'undefined')
    var scImgPath = ruta_raiz+'/js/spiffyCal/images/';
else {
...
function spiffyCalManager() {
	...
	this.Holidays = new Array("Ene-1","May-1","May-24","Ago-10","Nov-2","Dic-25");
	this.HolidaysDesc = new Array("Año Nuevo","Día del Trabajo","Batalla de Pichincha","1er. Grito de Independencia","Día de los Difuntos", "Navidad");
	//*****************************************
...
function ctlSpiffyCalendarBox(strVarName, strFormName, strTextBoxName, strBtnName, strDefaultValue, intBtnMode) {
	...
	var strDefBtnImgPath=calMgr.DefBtnImgPath;
	 if (ruta_raiz!=null){
	 	strDefBtnImgPath = ruta_raiz + '/js/spiffyCal/images/';
	 	//alert(ruta_raiz);
	 }
	/* PROPERTIES =============================================================
	 *
...
//		strHold='<input class="cal-TextBox" type="text" name="' + this.textBoxName + '"' + strTemp + 'size="12" value="' + this.getSelectedDate() + '">';
		strHold='<input class="cal-TextBox" type="text" name="' + this.textBoxName + '" id="' + this.textBoxName + '" ' + strTemp + 'size="12" value="' + this.getSelectedDate() + '">';
		...
		if ((this.focusClick==false) || (this.focusClick==true && this.hideButton==false))  {
			...
			strHold+='onclick="calc_fecha_fin();calMgr.swapImg(' + this.varName + ',\'.imgDown\',true);';
